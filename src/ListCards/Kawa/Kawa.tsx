          ...
          <div className="front" onClick={() => handleClick()}>
            <section className="main__section">
              ...
              <Info
                name="Kawa_"
                label="情報科学部・1年"
                mail="https://x.com/Kawa0x5f/"
                YoutubeLink="https://www.youtube.com/watch?v=gdZLi9oWNZg"
              />
              {/* 入門編: 自分自身ついての自己紹介文を書いてみましょう！ */}
              <About aboutText="C言語とPythonを使っています。AtCoderなどで競プロしてます。" />

              {/* 入門編: あなたの趣味はなんですか？*/}
              <Hobby hobbyText="プログラミングをしています。小説を読んでいたりもしていて、最近は東野圭吾さんの作品をよく読んでいます。" />
              ...
              <Footer
                twitterLink="https://x.com/Kawa0x5f/"
                githubLink="https://github.com/amatech-repo"
                instagramLink="https://instagram.com/kawasaki.y09?igshid=OGQ5ZDc2ODk2ZA==/"
                linkedinLink=""
              />
            </section>
          </div>
